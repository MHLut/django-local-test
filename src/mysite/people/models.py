...
class Person(models.Model):
    ...
    callsign = models.CharField(_("callsign"), max_length=32, blank=True)
    pronouns = models.CharField(_("pronouns"), max_length=16, blank=True)
    date_of_birth = models.DateField(_("date of birth"), blank=True, null=True)

    address_line_1 = models.CharField(_("address line 1"), max_length=64, blank=True)
    address_line_2 = models.CharField(_("address line 2"), max_length=64, blank=True)
...
class SocialLink(models.Model):
    ...
    service_name = models.CharField(_("service name"), max_length=32)
    username = models.CharField(_("username"), max_length=32)
    profile_url = models.URLField(_("profile URL"))
